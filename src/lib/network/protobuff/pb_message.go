...
type MessageInfo struct {
	...
	MsgHandler gservices.MessageHandler1 // 消息处理器
...
// 注册消息
// FIXME 非携程安全
func (msgManager *MsgManager) RegisterMessage(rawM RawMessage, handler gservices.MessageHandler1, msgServer *gservices.LocalServer) {
